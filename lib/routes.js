...
function mountActions(controller, actions, policy) {
  for (var id in controller) {
    ...
    // TODO: Add an Allow header containing a list of valid methods for 405 error code (#23)
    // TODO: GET and HEAD must never be disabled and should not return 405 error code (#24)
...
for (var ctrlName in controllers) {
  ...
  // TODO: Mount controller using full path to the controller/model (#22)
